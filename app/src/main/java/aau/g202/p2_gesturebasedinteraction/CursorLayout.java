...
public class CursorLayout extends Settings implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferences highAngleX_cursor = getApplicationContext().getSharedPreferences("HighAngleSpeedX", MODE_PRIVATE);
        final SharedPreferences.Editor cursorHighAngleXEdit = highAngleX_cursor.edit();

        SharedPreferences highAngleY_cursor = getApplicationContext().getSharedPreferences("HighAngleSpeedY", MODE_PRIVATE);
        final SharedPreferences.Editor cursorHighAngleYEdit = highAngleX_cursor.edit();

        //For Low speed Angle
        SharedPreferences lowAngleX_cursor = getApplicationContext().getSharedPreferences("LowAngleSpeedX", MODE_PRIVATE);
        final SharedPreferences.Editor cursorLowAngleXEdit = lowAngleX_cursor.edit();

        SharedPreferences lowAngleY_cursor = getApplicationContext().getSharedPreferences("LowAngleSpeedY", MODE_PRIVATE);
        ...
        cursorHighSpeedX_seekbar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener(){
            ...
            public void onStopTrackingTouch(SeekBar seekBar) {
                ...
                cursorHighSpeedXEdit.putInt("HighCursorSpeedXValue",cursorHighSpeedX_seekbar.getProgress());
        ...
        cursorHighSpeedY_seekbar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener(){
            ...
            public void onStopTrackingTouch(SeekBar seekBar) {
                ...
                cursorHighSpeedYEdit.putInt("HighCursorSpeedYValue",cursorHighSpeedY_seekbar.getProgress());
        ...
        cursorLowSpeedX_seekbar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener(){
            ...
            public void onStopTrackingTouch(SeekBar seekBar) {
                ...
                cursorLowSpeedXEdit.putInt("LowCursorSpeedXValue",cursorLowSpeedX_seekbar.getProgress());
        ...
        cursorLowSpeedY_seekbar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener(){
            ...
            public void onStopTrackingTouch(SeekBar seekBar) {
                ...
                cursorLowSpeedYEdit.putInt("LowCursorSpeedYValue",cursorLowSpeedY_seekbar.getProgress());
        ...
        cursorHighAngleX_seekbar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener(){
            ...
            public void onStopTrackingTouch(SeekBar seekBar) {
                ...
                cursorHighAngleXEdit.putInt("HighCursorAngleXValue",cursorHighAngleX_seekbar.getProgress());
        ...
        cursorHighAngleY_seekbar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener(){
            ...
            public void onStopTrackingTouch(SeekBar seekBar) {
                ...
                cursorHighAngleYEdit.putInt("HighCursorAngleYValue",cursorHighAngleY_seekbar.getProgress());
        ...
        cursorLowAngleX_seekbar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener(){
            ...
            public void onStopTrackingTouch(SeekBar seekBar) {
                ...
                cursorLowAngleXEdit.putInt("LowCursorAngleXValue",cursorLowAngleX_seekbar.getProgress());
        ...
        cursorLowAngleY_seekbar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener(){
            ...
            public void onStopTrackingTouch(SeekBar seekBar) {
                ...
                cursorLowAngleYEdit.putInt("LowCursorAngleYValue",cursorLowAngleY_seekbar.getProgress());
